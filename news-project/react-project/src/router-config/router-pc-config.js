...
import PcHome from "../components/pc/pc_home";
...
const RouterPCConfig =
<BrowserRouter>
    <Switch>
        <Route path='/' component={PcHome} exact></Route>
        <Route path='/header' component={PcHome}>PcHeader</Route>
